...
organization := "www.cogfor.com" // change to your org
...
libraryDependencies ++= Seq(
  ...
  // spark-modules
  // "org.apache.spark" %% "spark-graphx" % "1.6.2",
  ...
  "org.scalacheck"  %% "scalacheck"   % "1.13.0"      % "test,it",
...
mainClass in (Compile, packageBin) := Some("com.cogfor.ExampleClass")
